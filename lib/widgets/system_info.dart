    ...
    return Padding(
        ...
        child: Column(
          children: [
            ...
            buildBackendInfoLine(Constants.LBL_Version, dkSharedModel.backendSettings.version),
            buildBackendInfoLine(Constants.LBL_Environment, dkSharedModel.backendSettings.environment),
            buildBackendInfoLine(Constants.LBL_Message_Prefix, dkSharedModel.backendSettings.messagePrefix),
            buildBackendInfoLine(Constants.LBL_Secured, dkSharedModel.backendSettings.secured.toString()),
            // const SizedBox(height: 10),
            // const Row(
            //   mainAxisAlignment: MainAxisAlignment.start,
            //   children: [
