...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    chatAuthUserSubject.add(
      ChatAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ChatAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ChatAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    chatAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
