...
Widget wrapWithModel<T extends STYHModel>({
  required T model,
...
T createModel<T extends STYHModel>(
...
abstract class STYHModel<W extends Widget> {
...
class FlutterFlowDynamicModels<T extends STYHModel> {
